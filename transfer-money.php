...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/transfer-money.css">
            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a class="mr-20" href="transfer.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="bttn2">Transfer</button></a> 
                    </td>
